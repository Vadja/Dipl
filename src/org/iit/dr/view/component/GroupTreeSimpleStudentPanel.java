...
/**
 * GroupTreeSimpleStudentPanel.
 * 
 * @author Yuriy Karpovich
 */
public class GroupTreeSimpleStudentPanel extends JPanel
{
  ...
  UpdateDateTableModel updateDateTableModel;

  public GroupTreeSimpleStudentPanel( UpdateDateTableModel updateDateTableModel )
  {

    this.updateDateTableModel = updateDateTableModel;
        ...
        if( e.getButton() == MouseEvent.BUTTON1 )
        {
          ...
          if( activeNode != null )
          {
            ...
            if( root.equals( activeNode ) )
            {
              ...
              updateDateTableModel.updateData( null );
            }
            else
            {
              ...
              updateDateTableModel.updateData( StudentsService.getStudentIdByOUList( subOUIdList ) );
            }
          }
        }
      }
